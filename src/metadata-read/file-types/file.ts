 ...
 * To get a list of available properties see [Info.ts](../../general/info.ts)
 */
export default class FilePropertyBuilder {
	private readonly propertiesInclude: Array<string> = [];
	private readonly propertiesExclude: Array<string> = [];
     ...
     * @returns this to chain property selection
     */
	public withoutProperties(...properties: Array<string>): this {
     ...
     * @returns this to chain property selection
     */
	public withProperties(...properties: Array<string>): this {
		for (const property of properties) {
